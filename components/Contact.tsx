  ...
  return (
    <motion.div className="text-center md:text-left">
      ...
      <div className="bg-gradient relative z-[1] flex items-center justify-center pb-32 px-5">
        <div className="dark:bg-[rgba(0,0,0,.377)] bg-white/40 border border-white/30 p-6 rounded-lg backdrop-blur-lg shadow-lg w-full max-w-lg mt-[270px] text-left text-white">
        ...
        <div className="absolute top-0 left-0 w-full z-[-1] overflow-hidden leading-0">
          ...
          >
            <path
              ...
              opacity=".25"
              className={`${!theme ? "shape-fill-dark" : "shape-fill-white"}`}
            ></path>
            <path
