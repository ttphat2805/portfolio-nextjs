...
const Projects = (props: Props) => {
  ...
  return (
    ...
    <div id="container" className="flex w-[500vw]">
      <div id="component" className="one w-[100vw] h-[100vh]">
        Primeiro
      </div>
      <div id="component" className="two w-[100vw] h-[100vh]">
        Segundo
      </div>
      <div id="component" className="three w-[100vw] h-[100vh]">
        Terceiro
      </div>
      <div id="component" className="four w-[100vw] h-[100vh]">
        Quarto
      </div>
      <div id="component" className="five w-[100vw] h-[100vh]">
        Quinto
      </div>
    </div>
    // <div
